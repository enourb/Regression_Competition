...
save(loan_fold, loan_recipe, loan_split, loan_train, file = "data/temp_03/loan_setup.rda")


load("data/temp_03/rf_tune.rda")
load("data/temp_03/mars_tune.rda")
load("data/temp_03/knn_tune.rda")
load("data/temp_03/elastic_tune.rda")
load("data/temp_03/bt_tune.rda")
load("data/temp_03/nnet_tune.rda")
...
write.csv(final_predict, file = "data/temp_03/test_pred.csv", row.names = FALSE)
